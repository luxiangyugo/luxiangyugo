...
- 😋 I’m interested in **Processing and Interperting Monoview-Image from Drones**. Then **Georeference directly for Generating target traits distribution (in Crop Land)**. and Open Source COOL Things (😎such as [OpenDroneMap][ODM] and [ImageAnalysis][IMG_ANA]).
